...
while read -r line; do
    ...
    IFS='.' read -r n1 n2 n3 n4 <<< "$FIRST_NODE_IP"
...
pushd frr-k8s/hack/demo; ./demo.sh; popd
...
podman exec frr vtysh -c "$EVPN_CMDS"
...
podman exec frr vtysh -c "$FRR_CMDS"
podman exec frr vtysh -c "write memory"
